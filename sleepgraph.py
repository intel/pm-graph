...
class SystemValues:
	...
	dev_tracefuncs = {
		...
		'e1000e_pm_freeze': {},
		'__e1000_shutdown': {},
		'e1000_read_phy_reg_hv': {'args_x86_64':{'offset':'%si:x32'}},
		'e1000_read_phy_reg_hv_locked': {'args_x86_64':{'offset':'%si:x32'}},
		'e1000_write_phy_reg_hv': {'args_x86_64':{'offset':'%si:x32','data':'%dx:x16'}},
		'e1000_write_phy_reg_hv_locked': {'args_x86_64':{'offset':'%si:x32','data':'%dx:x16'}},
		'pci_enable_wake': {},
		...
		# vt
		'pm_vt_switch': {},
		'vt_event_post': {'args_x86_64': {'event':'%di:u32', 'old':'%si:u32', 'new':'%dx:u32'}},
		'vt_ioctl': {'args_x86_64': {'cmd':'%si:x32', 'arg':'%dx:x32'}},
		'vt_move_to_console': {'args_x86_64': {'vt':'%di:u32', 'alloc':'%si:s32'}},
		'vt_waitactive': {'args_x86_64': {'console':'%di:s32'}},
	}
	infocmds = [
		[0, 'sysinfo', 'uname', '-a'],
